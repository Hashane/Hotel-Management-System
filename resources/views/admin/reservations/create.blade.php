                ...
                <div class="modal-body py-4">
                    ...
                    <div class="d-flex justify-content-end mt-4 mb-4 pe-3">
                        <div class="text-end">
                            ...
                            <hr class="my-2">
                            <h5 class="mb-0"><strong>Total Amount:</strong> Rs. <span id="total-amount">{{
                                    $cartItems->count() != 0 ? number_format($priceBreakdown['totalAmount'], 2) : ''
                                    }}</span>
                            </h5>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('admin.carts.book') }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary px-4" id="book-now-btn" {{ $cartItems->count()
                                == 0 ? 'disabled' : '' }}>Book Now
                            </button>
                        </div>
                    </form>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <x-room-category-dropdown
                                            ...
                                            name="room_category" class="custom-class" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light border rounded p-3 text-center">
                                        ...
                                        <h4 class="fw-bold text-warning">{{ $data['partiallyAvailableRoomsCount'] }}
                                        </h4>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light border rounded p-3 text-center">
                                        ...
                                        <h4 class="fw-bold text-secondary">{{ $data['underMaintenanceRoomsCount'] }}
                                        </h4>
                                    </div>
                                </div>
                            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <form action="{{ route('admin.carts.store') }}" method="POST">
                            ...
                            <td>
                                <input type="number" name="occupants" value="{{ $room->capacity }}" min="1"
                                    max="{{ $room->capacity }}" class="form-control form-control-sm"
                                    style="width: 80px;">
                            ...
                            <td class="text-center">
                                <button type="submit" class="btn btn-sm btn-success px-3" {{
                                    $cartItems->contains('room_id', $room->id) ? 'disabled' : '' }}>
                                    Add to Cart
                                </button>
                            </td>
                        </form>
