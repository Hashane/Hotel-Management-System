                    ...
                    <tbody>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center align-items-center gap-3 py-1">
                                @if(!$roomReservation->checked_in_at)
                                <!-- Not checked in yet -->
                                <button type="button" class="btn btn-sm btn-success px-3 w-100"
                                    style="max-width: 160px;" data-bs-toggle="modal" data-bs-target="#checkInModal"
                                    data-bs-reservation="{{ $reservation->id }}">
                                    <i class="fas fa-door-open me-1"></i> Check In
                                </button>
                                ...
                                @else
                                <!-- Already checked out -->
                                <button type="button" class="btn btn-sm btn-secondary px-3 w-100"
