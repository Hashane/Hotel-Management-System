            ...
            <div class="row">
                <div class="col-5 col-sm-3 mt-4">
                    <div class="nav flex-column nav-tabs " id="vert-tabs-tab" role="tablist"
                        ...
                        <a class="nav-link" id="vert-tabs-prices-tab" data-toggle="pill" href="#vert-tabs-prices"
                           role="tab"
                        ...
                        <a class="nav-link" id="vert-tabs-images-tab" data-toggle="pill" href="#vert-tabs-images"
                           role="tab"
                ...
                <div class="col-7 col-sm-9">
                    <div class="tab-content" id="vert-tabs-tabContent">
                        ...
                        {{-- *** PRICES *** --}}
                        <div class="tab-pane fade" id="vert-tabs-prices" role="tabpanel"
                             aria-labelledby="vert-tabs-prices-tab">
                            <div class="card card-info shadow-sm mt-4">
                                <div class="card-header">
                                            ...
                                            <div class="container mt-2">
                                                <form action="#" method="POST">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="number" name="operating_cost"
                                                                   class="form-control" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="number" name="tax_rule" class="form-control"
                                                                   required>
                                                        </div>
                                                    </div>
                        ...
                        {{-- *** SEO *** --}}
                        <div class="tab-pane fade" id="vert-tabs-seo" role="tabpanel"
