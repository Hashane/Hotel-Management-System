                            ...
                            <div class="container">
                                ...
                                @foreach ($features as $index => $feature)
                                    <div class="row align-items-center border-bottom mt-2 pb-2">
                                        ...
                                        {{-- Action Icons --}}
                                        <div class="col-md-2">
                                            <i class="far fa-eye text-primary me-2" title="View" role="button"
                        ...
                        <div class="bg-body-tertiary p-4 rounded mb-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <p class="form-control-plaintext h6 mb-0">
                                        Enjoy complimentary high-speed internet in all guest rooms and public areas
                                        during your stay.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <p class="form-control-plaintext h6 mb-0">
                                        https://yourhotel.com/room-type/free-wifi</p>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="border p-2 rounded" style="max-width: 150px;">
                                        <img src="{{ asset('images/features/wifi.png') }}" alt="Wi‑Fi"
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="bg-body-tertiary p-4 rounded mb-4">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label h6">Pre-Tax Operating Cost</label>
                                        <input type="number" name="pre_tax_operating" class="form-control"
                                               value="100.00">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label h6">Pre-Tax Retail Price</label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label h6">Retail Price (Incl. Tax)</label>
                                        <input type="number" name="retail_price_with_tax" class="form-control"
                                               value="132.00">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="meta_title" class="form-control"
                                               value="Free Wi‑Fi Access in Every Room">
                                    </div>
                                </div>
